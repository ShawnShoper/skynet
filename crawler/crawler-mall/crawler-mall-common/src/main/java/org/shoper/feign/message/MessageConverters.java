package org.shoper.feign.message;
...
public class MessageConverters {
    ...
    public MessageConverters() {
        ...
        if (jackson2Present) {
            ...
            try {
                Class<?> jackson = Class.forName("org.springframework.http.converter.json.MappingJacksonHttpMessageConverter");
                this.messageConverters.add((HttpMessageConverter<?>) jackson.newInstance());
            } catch (Exception e) {
                e.printStackTrace();
            }
